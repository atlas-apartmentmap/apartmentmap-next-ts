...
export const _tours = [...Array(12)].map((_, index) => {
  const location = apartments.map((option) => option.address)[index + 1];

  const apartmentName = apartments.map((option) => option.label)[index + 1];
  ...
  const heroUrl = [
    '/assets/images/brisbane/building_1.jpg',
    '/assets/images/brisbane/building_2.jpg',
    '/assets/images/brisbane/building_3.jpg',
    '/assets/images/brisbane/building_4.jpg',
    '/assets/images/brisbane/building_5.jpg',
  ][index];
