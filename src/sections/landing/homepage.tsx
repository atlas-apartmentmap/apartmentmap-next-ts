...
function HeroSection() {
  ...
  return (
    <Box sx={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', textAlign: 'center', color: 'common.white' }}>
      <Stack
        spacing={5}
        sx={{
          zIndex: 9,
      ...
      >
        ...
        <Typography variant="h6">Discover amazing content and stay updated with the latest trends.</Typography>
