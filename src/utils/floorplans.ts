// src/utils/floorPlans.ts

export const getFloorPlansForObject = async (objectName: string): Promise<string[]> => {
    const floorPlans: string[] = [];
    const basePath = `/assets/floorplans/sky-tower/${objectName}`;
    let index = 1;
